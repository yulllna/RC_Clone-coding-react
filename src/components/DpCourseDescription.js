            ...
            <div className="dp-container">
              <div className="cd-header-content">
                <div className="cd-header_left">
                  <a href="#" className="cd-header_thumbnail">
                    <img
                      src="https://cdn.inflearn.com/public/courses/328001/cover/e11c6e6a-14c6-494a-954d-5fc625eb89a6/328001-eng.png"
                      alt="헤더 이미지"
                    />
                    <div className="thumbnail-button-cover thumbnail-bottom-button-cover e-preview">
                      <button className="thumbnail-bottom-button">
                        ...
                        <span className="thumbnail-bottom-button__highlight">
                          1개
                        </span>{' '}
                        미리 보기
                      </button>
                ...
                <div className="cd-header_right">
                  <div className="cd-header__breadcrumb">
                    <span className="cd-header__breadcrumb-el">
                      개발 · 프로그래밍
                    </span>
                    <span className="infd-icon">
                      <svg
                  ...
                  <div className="cd-header__tags cd-header__sub-row">
                    ...
                    <a
                      href="/tag-curation/skill/103"
                      target="_blank"
                      className="cd-header__tag"
                    >
                      Swift
                    </a>
                    <a
                      href="/tag-curation/skill/29041"
                      target="_blank"
                      className="cd-header__tag"
                    >
                      IOS
...
export default DpCourseDescription;
